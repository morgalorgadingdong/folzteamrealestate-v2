...
<section id="folzTeamStory" class="flexCenterH flexWrap center">
    <div class="content-container d-flex justify-content-start align-items-around flex-wrap my-0 px-3 pb-3">
...
<section class="d-flex justify-content-center align-content-center flex-wrap col-12">
